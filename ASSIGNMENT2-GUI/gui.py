...
class myApp:
    def __init__(self, root):
        ...
        # Pulsante Modifica studente e entry per la matricola
        ...
        # Pulsante Cancella studente e entry per la matricola
        ...
        # Pulsante Media e entry per la matricola
        ...
        # Pulsante Carica l'archivio da file
        ...
        # Salva archivio su file e entry per il nome del file
    ...
    # Controllo sui caratteri inseriti nei campi di input
    ...
    # Chiudere una finestra secondaria dell'applicazione    
    ...
    def finestra_visualizzaArchivio(self, event):
        ...
        self.box_visualizzaArchivio.configure(state="disabled") # La textbox è di sola lettura, così l'utente non può pensare di modificare l'archivio da questa finestra
    ...
    def inserisciStudente(self, event):
        ...
        if self.contiene_solo_caratteri(cognome, chars_nomecognome, "cognome") and self.contiene_solo_caratteri(nome, chars_nomecognome, "nome") and self.contiene_solo_caratteri(matricola, numeri, "matricola"):
            ...
            if not (input_esami is None or input_esami == "" or input_esami == self.entry_esami.placeholder) and (self.contiene_solo_caratteri(input_esami, numeri + lettere + " " + "-" + ",", "esami")): #Dato che ho inserito i placeholder devo considerare che esami_input sia uguale al placeholder            
                # Estrapolo il codice e il voto di ciascun esame inserito nel campo, e li aggiungo come tupla alla lista_esami                
                codici_esami = [] # Lista per controllare che non venga inserito due volte lo stesso esame
                    ...
                    try:
                        ...
                        if esame and len(esame) == 2:
                            ...
                            if codice in codici_esami:
                                messagebox.showerror("Errore", "Il codice dell'esame " + str(codice) + " è duplicato.")
                                return
                        ...
                        messagebox.showerror("Errore", "Controllare il formato e la correttezza dei dati nella lista degli esami.")
                        return
        ...
        if risposta == True:
            ...
            if self.contiene_solo_caratteri(cognome, chars_nomecognome, "cognome") and self.contiene_solo_caratteri(nome, chars_nomecognome, "nome") and self.contiene_solo_caratteri(matricola, numeri, "matricola"):           
                ...
                try:
                    ...
                    messagebox.showerror("Errore", "Impossibile salvare: controllare la formattazione e la correttezza dei valori nella lista degli esami.")
                    return
                self.archivio.modifica_note(int(matricola), note)
                messagebox.showinfo("Modifica avvenuta", "Lo studente è stato modificato correttamente.")
                self.chiudi_finestra()
    ...
    def chiudi(self, event):
        ...
        if risposta == True:
            ...
            messagebox.showinfo("Salvataggio completato", "L'archivio è stato salvato correttamente nel file " + filenameOggi + ".")
            root.destroy()
        elif risposta == False:
            root.destroy()
...
###### ALTRE CLASSI UTILIZZATE NELLA GUI ######
# Classe per placeholder
...
# Classe per tooltip (testo hover su un widget)
